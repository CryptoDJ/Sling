...
}]), angular.module("minovateApp").directive("navCollapse", function() {
    return {
        restrict: "A",
        link: function(a, b) {
...
}]), angular.module("minovateApp").controller("OverviewCtrl", ["$scope", function(a) {
    a.page = {
        title: "Overview",
        subtitle: "Funds and Market:"
    }
}]), angular.module("minovateApp").controller("SendCtrl", ["$scope", function(a) {
    a.page = {
        title: "Send",
        subtitle: "Funds"
    }
}]), angular.module("minovateApp").controller("ReceiveCtrl", ["$scope", function(a) {
    a.page = {
        title: "Receive",
        subtitle: "Funds"
    }
}]), angular.module("minovateApp").controller("TransactionsCtrl", ["$scope", function(a) {
    a.page = {
        title: "Transactions",
        subtitle: "Funds"
    }
}]), angular.module("minovateApp").controller("AddressBookCtrl", ["$scope", function(a) {
    a.page = {
        title: "Address Book",
        subtitle: "Funds"
    }
}]), angular.module("minovateApp").controller("MarketBookCtrl", ["$scope", function(a) {
    a.page = {
        title: "Market",
        subtitle: "Buy & Sell"
    }
}]), angular.module("minovateApp").controller("ChatBookCtrl", ["$scope", function(a) {
    a.page = {
        title: "Chat",
        subtitle: "Messages"
    }	
}]), angular.module("minovateApp").controller("MasterNodeCtrl", ["$scope", function(a) {
    a.page = {
        title: "Master Nodes",
        subtitle: "Setup"
    }	
}]), angular.module("minovateApp").controller("BlocksNodeCtrl", ["$scope", function(a) {
    a.page = {
